                ...
                <body>
                    <div class="main">
                                ...
                                <br>
                                    ...
                                    <div class="menu_nav">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="owner_de.jsp">Owner Details</a></li>
                                            <li><a href="user_de.jsp">Receiver Details</a></li>
                        ...
                        <div class="content">
                            ...
                            <center>
                                <!--  start body--->
<br><br><center><h2 style="font-size: 22px; color: #008dde; font-family: cursive">Owner Details</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            <th style="text-align: center;width: 200px; font-size: 16px; color: black">Owner ID</th>
                            <th style="text-align: center;width: 200px; font-size: 16px; color: black">Owner Name</th>
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: black">email</th>
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: black">DOB</th>
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: black">Gender</th>
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: black">Phone</th>
                        </tr>
                        <tr>
                            <%
                                Connection con = null;
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from reg where role='Data Owner'");
                                    while (rs.next()) {
                            %>
