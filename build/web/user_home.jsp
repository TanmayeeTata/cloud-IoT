<%-- 
    Document   : user_home
    Created on : Oct 17, 2017, 12:14:53 PM
    Author     : java4
--%>
                            ...
                            <div class="header_resize">
                                ...
                                <br>
                                    ...
                                    <div class="menu_nav">
                                        ...
                                        <ul>
                                            <li class="active"><a href="user_home.jsp.jsp">Home</a></li>
                            ...
                            <div class="content_resize">
                                <div>
                                    <div class="article">
                                        <!--- Content start---->
                                        <center>  <br>  
                                                <font style="font-family: initial; font-size: 22px; color: #008dde">Welcome : </font>&nbsp;<font style="font-family: initial; font-size: 22px; color: #2ecc71"><%=session.getAttribute("sname")%></font><br></br>
                                        <img src="images/user.jpg" width="800" height="350" />
                                        </center>
