<%-- 
    Document   : user_req
    Created on : Oct 17, 2017, 11:24:35 AM
    Author     : java4
--%>
                ...
                <body>
                    <div class="main">
                            ...
                            <div class="header_resize">
                                ...
                                <br>
                                    ...
                                    <div class="menu_nav">
                                        ...
                                        <ul>
                                            <li><a href="own_home.jsp">Home</a></li>
                                            <li><a href="upload.jsp">File Upload</a></li>
                                            <li><a href="file_de.jsp">file Details</a></li>
                                            <li class="active"><a href="user_req.jsp">Receiver Req</a></li>
                        ...
                        <div class="content">
                            ...
                            <center>
                                <!--  start body--->
<br><br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">User Request</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 300px;  font-size: 16px; color: black">User ID</th>
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: black">User Name</th>
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: black">Status</th>
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: green">Response</th>
                        </tr>
                        <tr>
                            <%
                                Connection con = null;
                                ...
                                try {
                                    ...
                                    while (rs.next()) {
                            %>
                            <td style="font-size: 16px"><center><%=rs.getString("fid")%></center></td>   
                            <td style="font-size: 16px"><center><%=rs.getString("fname")%></center></td>   
                            <td style="font-size: 16px"><center><%=rs.getString("attribute")%></center></td>  
                            <td style="font-size: 16px"><center><%=rs.getString("uid")%></center></td>  
                            <td style="font-size: 16px"><center><%=rs.getString("uname")%></center></td>  
                            <td style="font-size: 16px"><center><%=rs.getString("status")%></center></td>  
                            <td><a href="response.jsp?<%=rs.getString("id")%>"><font style="color: green; font-size: 16px"><center>Click</center></a></td>
                        </tr>
                        <%
