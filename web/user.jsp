<%-- 
    Document   : owner
    Created on : Oct 12, 2017, 12:36:45 PM
    Author     : java4
--%>
                                ...
                                <br>
                                    ...
                                    <div class="menu_nav">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="user.jsp">Data Receiver</a></li>
                            ...
                            <div class="content_resize">
                                <div class="mainbar">
                                    <div class="article">
                                        ...
                                        <div id="login">
                                            <font style="color: #0064ab; font-family: fantasy;font-size: 18px">Receiver Login Here!!</font><br></br>
                                            <form action="action.jsp" method="get" >
                                                <fieldset>
                                                    <p><input type="text" required name="name" placeholder="User Name" /></p>
                                                    <p><input type="password" required name="password" placeholder="Password" /><input type="hidden" required name="status" value="2" /></p>
                                                    <p><input type="submit" value="Login"></p>
                                                    <p><a style="font-size: 16px; color: #848383" href="reg.jsp">New User Signup?</a></p>
                                                </fieldset>
                                            </form>
                                        </div>
