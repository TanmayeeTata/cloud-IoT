<%-- 
    Document   : file_de
    Created on : Oct 16, 2017, 4:55:56 PM
    Author     : java4
--%>
...
<br><br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">FILE DETAILS</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: blue">View File</th>
                        </tr>
                        <tr>
                            <%
                                Connection con = null;
                            ...
                            <td><a href="view_file.jsp?<%=rs.getString("id")%>"><font style="color: green; font-size: 16px"><center>View</center></a></td>
                        </tr>
                        <%
