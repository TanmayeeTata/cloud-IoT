<%-- 
    Document   : file_req1
    Created on : Oct 17, 2017, 5:59:18 PM
    Author     : java4
--%>
                ...
                <body>
                    <div class="main">
                                ...
                                <br>
                                    ...
                                    <div class="menu_nav">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="file_req1.jsp">Sent Req</a></li>
                        ...
                        <div class="content">
                            ...
                            <center>
                                <!--  start body--->
<br><br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">SENT FILES REQUEST</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 400px;  font-size: 16px; color: black">Attribute</th>
                        </tr>
                            <tr>
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from request where attribute='"+att+"'");
                                    while (rs.next()) {
                            %>
