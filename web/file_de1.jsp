<%-- 
    Document   : file_de1
    Created on : Oct 17, 2017, 12:24:44 PM
    Author     : java4
--%>
                                ...
                                <br>
                                    ...
                                    <div class="menu_nav">
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="file_de1.jsp">File Details</a></li>
                                            <li><a href="file_req1.jsp">Sent Req</a></li>
...
<br><br><center><h2 style="font-size: 26px; color: deepskyblue; font-family: cursive">FILE DETAILS</h2>
                    <br><table border="2" style="text-align: center; margin-left: 0px; border-color: black">
                        <tr>
                            ...
                            <th style="text-align: center;width: 200px;  font-size: 16px; color: blue">Send Request</th>
                        </tr>
                            <tr>
                            <%
                                ...
                                try {
                                    ...
                                    rs = st.executeQuery("select * from upload where policy LIKE '%"+att+"%'");
                                    while (rs.next()) {
                            %>
                            ...
                            <td><a href="request.jsp?id=<%=rs.getString("id")%>&filename=<%=rs.getString("filename")%>&skey=<%=rs.getString("skey")%>"><font style="color: green; font-size: 16px"><center>Send</center></a></td>
